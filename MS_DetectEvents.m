function [evts, detect_csc, cfg] = MS_DetectEvents(cfg_in, data, ExpKeys)
...
evt_chew = DetectEvents(cfg_chew,csc,ExpKeys);
...
cfg_spindl.filter_cfg.f = [7 11]; % default [7-11]
...
evt_spindl = DetectEvents(cfg_spindl,csc,ExpKeys);
...
for iFreq = 1:length(cfg.f_label)
    ...
    [evt,evt_thr] = DetectEvents(cfg_evt,csc,ExpKeys);
